       ...
       <div class="row row-header">
            <div class="col-xs-12">
                <ol class="breadcrumb">
				     ...
				     <li class="active">Заблокированные вопросы </li>
			    </ol>
            </div>
        </div>
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading"> <b class='tb_header'> Заблокированные вопросы </b></div>
                ...
                <div class="panel-body">
                    ...
                    <tbody>
                     ...
                     <td>  {{ $item->tag }}  </td>
                     <td>  {{ $item->visible }}  </td>
                    <td>  {{ $item->censored_words }}  </td>
                     <td>
                     <a href="allowQuestion/{{ $item->id }} /{{ $item->tag }} "> Разблокировать  </a> |
